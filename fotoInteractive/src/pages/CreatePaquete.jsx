                ...
                <div className=" bg-white shadow rounded-lg p-8 mb-10">
                    <form className="space-y-4 md:space-y-6 max" method="POST">
                        ...
                        <div className="flex justify-end">
                            <button type="submit" className="flex items-center gap-2 text-white bg-blue-600 hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-6 py-2.5 text-center dark:bg-palete-1 dark:hover:bg-palete-3 dark:focus:ring-blue-900"><FaPlus /> Agregar nuevo paquete</button>
                        </div>
                    </form>
